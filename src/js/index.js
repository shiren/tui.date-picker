...
/**
 * Create a calendar. Refer to the [Calendar example](/tutorial-example07-calendar).
 * @static
 * @param {HTMLElement|string} container - Container element or selector of the Calendar
...
/**
 * Create a date-range picker. Refer to the [DateRangePicker example](/tutorial-example08-daterangepicker).
 * @static
